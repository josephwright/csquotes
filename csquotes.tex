...
% \begin{release}{??}{????-??-??}
% \item Add support for Welsh
% \end{release}

\begin{release}{5.2p}{2026-05-19}
 \item Add \cmd{measuring@true} to \cmd{blockquote@parsehook} for better tagging support, see issue \#81.
\end{release}
